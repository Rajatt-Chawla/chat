from sqlalchemy import Column, DateTime, Float, ForeignKey, Index, Integer, BigInteger, String, Text
...
class EmotionalHistory(Base):
    ...
    source_message_id = Column(BigInteger().with_variant(Integer, "sqlite"), ForeignKey("chat_history.id", ondelete="SET NULL"), nullable=True)
